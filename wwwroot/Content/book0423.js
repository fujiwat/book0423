...
{
 "use strict";
 var book0423,Client,WebSharper,Obj,UI,Var$1,ListModel,Entry,Operators,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Var,Handler,Unchecked,book0423_Templates,Seq,Doc,ConcreteVar,Snap,Numeric,System,Guid,Collections,List,Strings,JavaScript,Pervasives,Client$1,Templates,Enumerator,T,Array,Abbrev,Fresh,Storage,View,Dictionary,Object,HashSet,TemplateInitializer,EventTarget,Node,JS,List$1,T$1,AttrProxy,CheckedInput,ArrayStorage,DictionaryUtil,SC$1,WindowOrWorkerGlobalScope,Docs,DocElemNode,CharacterData,SC$2,Elt,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,AttrModule,Updates,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$3,HashSetUtil,BindVar,SC$4,SC$5,AppendList,SC$6,DynamicAttrNode,Scheduler,Easing,AsyncBody,SC$7,CT,HashSet$1,Queue,String,CancellationTokenSource,DomNodes,Char,Error,OperationCanceledException,Lazy,SC$8,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime$1,console,Math,Date;
 book0423=Global.book0423=Global.book0423||{};
 Client=book0423.Client=book0423.Client||{};
 ...
 book0423_Templates=Global.book0423_Templates=Global.book0423_Templates||{};
 ...
 SC$2=Global.StartupCode$WebSharper_UI$Abbrev=Global.StartupCode$WebSharper_UI$Abbrev||{};
 Elt=UI.Elt=UI.Elt||{};
 ...
 {
  var newEntryTitle,newEntryAuthor,newEntryPublished,msg,cap,allBooks,Books,data,a,b,t,t$1,_this,_this$1,_this$2,_this$3,_this$4,C,_this$5,p,i;
  function row(entry)
  {
   var b$1,_this$6,_this$7,_this$8,_this$9,p$1,i$1;
   return(b$1=(_this$6=(_this$7=(_this$8=(_this$9=new ProviderBuilder.New$1(),(_this$9.h.push({
    $:1,
    $0:"flag",
    $1:entry.Flag
    ...
    $:1,
    $0:"published",
    $1:Global.String(entry.Published)
   }),_this$6)),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],book0423_Templates.row(p$1[0])),b$1.i=i$1,i$1))).get_Doc();
  }
  newEntryTitle=Var$1.Create$1("");
  newEntryAuthor=Var$1.Create$1("");
  newEntryPublished=Var$1.Create$1(2022);
  msg=Var$1.Create$1("");
  cap=Var$1.Create$1("=== REGISTERED BOOKS ===");
  allBooks=ListModel.FromSeq([Entry.Create("","In Search of Lost Time","Marcel Proust",1900),Entry.Create("","Ulysses","James Joyce",1901),Entry.Create("","Don Quixote","Miguel de Cervantes",1902),Entry.Create("","One Hundred Years of Solitude","Gabriel Garcia Marquez",1903),Entry.Create("","The Great Gatsby","F. Scott Fitzgerald",1904),Entry.Create("","Moby Dick","Herman Melville",1905),Entry.Create("","War and Peace","Leo Tolstoy",1906),Entry.Create("","Hamlet","William Shakespeare",1907),Entry.Create("","The Odyssey","Homer",1908),Entry.Create("","Madame Bovary","Gustave Flaubert",1909),Entry.Create("","The Divine Comedy","Dante Alighieri",1910),Entry.Create("","Lolita","Vladimir Nabokov",1911),Entry.Create("","The Brothers Karamazov","Fyodor Dostoyevsky",1912),Entry.Create("","Crime and Punishment","Fyodor Dostoyevsky",1913),Entry.Create("","Wuthering Heights","Emily Bront?",1914),Entry.Create("","The Catcher in the Rye","J. D. Salinger",1915),Entry.Create("","Pride and Prejudice","Jane Austen",1916),Entry.Create("","The Adventures of Huckleberry Finn","Mark Twain",1917),Entry.Create("","Anna Karenina","Leo Tolstoy",1918),Entry.Create("","Alice's Adventures in Wonderland","Lewis Carroll",1919),Entry.Create("","The Iliad","Homer",1920),Entry.Create("","To the Lighthouse","Virginia Woolf",1921),Entry.Create("","Catch-22","Joseph Heller",1922),Entry.Create("","Heart of Darkness","Joseph Conrad",1923),Entry.Create("","The Sound and the Fury","William Faulkner",1924),Entry.Create("","Nineteen Eighty Four","George Orwell",1925),Entry.Create("","Great Expectations","Charles Dickens",1926),Entry.Create("","One Thousand and One Nights","India/Iran/Iraq/Egypt",1927),Entry.Create("","The Grapes of Wrath","John Steinbeck",1928),Entry.Create("","Absalom, Absalom!","William Faulkner",1929),Entry.Create("","Invisible Man","Ralph Ellison",1930),Entry.Create("","To Kill a Mockingbird","Harper Lee",1931),Entry.Create("","The Trial","Franz Kafka",1932),Entry.Create("","The Red and the Black","Stendhal",1933),Entry.Create("","Middlemarch","George Eliot",1934),Entry.Create("","Gulliver's Travels","Jonathan Swift",1935),Entry.Create("","Beloved","Toni Morrison",1936),Entry.Create("","Mrs. Dalloway","Virginia Woolf",1937),Entry.Create("","The Stories of Anton Chekhov","Anton Chekhov",1938),Entry.Create("","The Stranger","Albert Camus",1939),Entry.Create("","Jane Eyre","Charlotte Bronte",1940),Entry.Create("","The Aeneid","Virgil",1941),Entry.Create("","Collected Fiction","Jorge Luis Borges",1942),Entry.Create("","The Sun Also Rises","Ernest Hemingway",1943),Entry.Create("","David Copperfield","Charles Dickens",1944),Entry.Create("","Tristram Shandy","Laurence Sterne",1945),Entry.Create("","Leaves of Grass","Walt Whitman",1946),Entry.Create("","The Magic Mountain","Thomas Mann",1947),Entry.Create("","A Portrait of the Artist as a Young Man","James Joyce",1948),Entry.Create("","Midnight's Children","Salman Rushdie",1949)]);
  Books=ListModel.FromSeq([]);
  allBooks.Iter(function(t$2)
  {
   Books.Append(Entry.Create(t$2.Flag,t$2.Title,t$2.Author,t$2.Published));
  });
  data=Doc.BindView(function(lm)
  {
   return Doc.Concat(Seq.map(row,lm));
  },Books.v);
  a=(b=(t=(t$1=(_this=(_this$1=(_this$2=(_this$3=(_this$4=(C=cap.get_View(),(_this$5=new ProviderBuilder.New$1(),(_this$5.h.push({
   $:2,
   $0:"caption",
   $1:C
   ...
   $0:"msg",
   $1:msg
  }),_this)),(t$1.h.push(Handler.EventQ2(t$1.k,"reister",function()
  {
   return t$1.i;
  },function()
  {
   cap.Set("=== REGISTERED BOOKS ===");
   Books.Clear();
   Books.Append(Entry.Create("Registered",newEntryTitle.Get(),newEntryAuthor.Get(),newEntryPublished.Get()));
   allBooks.Iter(function(t$2)
   {
    Books.Append(Entry.Create(t$2.Flag,t$2.Title,t$2.Author,t$2.Published));
   });
   allBooks.Clear();
   Books.Iter(function(t$2)
   {
    allBooks.Append(Entry.Create(t$2.Flag,t$2.Title,t$2.Author,t$2.Published));
   });
   msg.Set("Book \""+Global.String(newEntryTitle.Get())+"\" by \""+Global.String(newEntryAuthor.Get())+"\" is added to the top.");
   newEntryTitle.Set("");
  ...
  {
   cap.Set("=== BOOK SEARCH RESULT ===");
   Books.Clear();
   allBooks.Iter(function(t$2)
   {
    (Strings.Trim(newEntryTitle.Get())==""||t$2.Title.toLowerCase().indexOf(newEntryTitle.Get().toLowerCase())!=-1)&&(Strings.Trim(newEntryAuthor.Get())==""||t$2.Author.toLowerCase().indexOf(newEntryAuthor.Get().toLowerCase())!=-1)?Books.Append(Entry.Create(t$2.Flag,t$2.Title,t$2.Author,t$2.Published)):void 0;
   });
   msg.Set(Books.get_Length()===0?(Books.Append(Entry.Create("","","",0)),"Book \""+newEntryTitle.Get()+"\" by \""+newEntryAuthor.Get()+"\" is not found."):"Book \""+newEntryTitle.Get()+"\" by \""+newEntryAuthor.Get()+"\" is found, "+Global.String(Books.get_Length())+(Books.get_Length()===1?" Book.":" Books."));
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["title",0],["author",0],["published",1],["msg",0]]),(i=new TemplateInstance.New(p[1],book0423_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Entry.Create=function(flag,title,author,published)
 {
  return Entry.New(flag,title,author,published);
 };
 Entry.New=function(Flag,Title,Author,Published)
 {
  return{
   Flag:Flag,
   Title:Title,
 ...
 book0423_Templates.main=function(h)
 {
 ...
 book0423_Templates.row=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.GlobalHoles=new Dictionary.New$5();
  SC$1.TextHoleRE="\\${([^}]+)}";
  SC$1.RenderedFullDocTemplate=null;
 };
 ...
 SC$6.$cctor=function()
 {
  ...
  SC$6.EmptyAttr=null;
  SC$6.BoolCheckedApply=function(_var)
  {
   function set(el,v)
   {
  ...
  SC$6.StringApply=(g=BindVar.StringGet(),(s=BindVar.StringSet(),function(v)
  {
   return BindVar.ApplyValue(g,s,v);
  }));
  SC$6.IntSetUnchecked=function(el)
  {
   return function(i)
   {
  ...
  SC$6.IntGetUnchecked=function(el)
  {
   var s$5,pd;
   s$5=el.value;
  ...
  SC$6.IntApplyUnchecked=(g$1=BindVar.IntGetUnchecked(),(s$1=BindVar.IntSetUnchecked(),function(v)
  {
   return BindVar.ApplyValue(g$1,s$1,v);
  }));
  SC$6.IntSetChecked=function(el)
  {
   return function(i)
   {
    var i$1;
  ...
  SC$6.IntGetChecked=function(el)
  {
   var s$5,m,o;
   s$5=el.value;
   return{
  ...
  SC$6.IntApplyChecked=(g$2=BindVar.IntGetChecked(),(s$2=BindVar.IntSetChecked(),function(v)
  {
   return BindVar.ApplyValue(g$2,s$2,v);
  }));
  SC$6.FloatSetUnchecked=function(el)
  {
   return function(i)
   {
    el.value=Global.String(i);
  ...
  SC$6.FloatGetUnchecked=function(el)
  {
   var s$5,pd;
   s$5=el.value;
   return String.isBlank(s$5)?{
  ...
  SC$6.FloatApplyUnchecked=(g$3=BindVar.FloatGetUnchecked(),(s$3=BindVar.FloatSetUnchecked(),function(v)
  {
   return BindVar.ApplyValue(g$3,s$3,v);
  }));
  SC$6.FloatSetChecked=function(el)
  {
   return function(i)
   {
    var i$1;
  ...
  SC$6.FloatGetChecked=function(el)
  {
   var s$5,i;
   s$5=el.value;
   return{
  ...
  SC$6.FloatApplyChecked=(g$4=BindVar.FloatGetChecked(),(s$4=BindVar.FloatSetChecked(),function(v)
  {
